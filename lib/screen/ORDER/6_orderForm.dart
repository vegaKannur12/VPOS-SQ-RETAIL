                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(
                                      left: 30.0, right: 15),
                                  child: widget.type == "sales-R"
                                      ? Container(
                                          // height: size.height * 0.06,
                                          child: Autocomplete<
                                              Map<String, dynamic>>(
                                            initialValue: TextEditingValue(
                                                text: values.areaSelecton ==
                                                            null ||
                                                        values.areaSelecton!
                                                            .isEmpty
                                                    ? widget.areaname
                                            ...
                                            onSelected: (value) {
                                              setState(() {
                                                ...
                                                setState(() {
                                                  print(
                                                      "seting def cus ---${values.settingsList1[0]["set_value"].toString()}");
                                                  print(
                                                      "nnnnn-----${values.dfCusName.toString()}");
                                                  values.customertext.text =
                                                      values.dfCusName
                                                          .toString();
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: <Widget>[
                                                                        ...
                                                                        values.custmerDetails.isNotEmpty
                                                                            ...
                                                                            : Text(
                                                                                "No Customer Found!!!",
                                                                                style: TextStyle(fontSize: 17, color: P_Settings.extracolor),
                                                                              ),
                                                                      ],
                                                                    ),
                                                                  ),
