...
///////////////////////////////////////////////////////
  ...
  getCustomerR(String? aid, String cusCode) async {
    String arid;
    print("aid...............${aid}");
    try {
      print("custmerDetails after clear----${custmerDetails}");
      ...
      customerList = await OrderAppDB.instance.getCustomerR(arid, cusCode);
      // customerList = await OrderAppDB.instance.getCustomerR(arid, "C@102");
      print("customerList----${customerList}");
      for (var item in customerList) {
        custmerDetails.add(item);
      }
      ...
      dfCusName = "";
      dfcusCode = "1";
      customertext.text = dfCusName.toString().toLowerCase() == "null"
          ? ""
          : dfCusName.toString();
      print("defcus=====${dfCusName}");
      notifyListeners();
    } catch (e) {
      print(e);
      return null;
